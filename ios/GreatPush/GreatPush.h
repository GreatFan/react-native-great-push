...
@interface GreatPush : RCTEventEmitter
 ...
 * that was downloaded as part of a GreatPush update. The value returned
 ...
 * the Info.plist file's GreatPushDeploymentKey setting.
 */
...
@interface GreatPushConfig : NSObject
...
@interface GreatPushDownloadHandler : NSObject <NSURLConnectionDelegate>
...
@interface GreatPushErrorUtils : NSObject

+ (NSError *)errorWithMessage:(NSString *)errorMessage;
+ (BOOL)isGreatPushError:(NSError *)error;

@end

@interface GreatPushPackage : NSObject
...
@interface GreatPushTelemetryManager : NSObject
...
@interface GreatPushUpdateUtils : NSObject
...
typedef NS_ENUM(NSInteger, GreatPushInstallMode) {
    GreatPushInstallModeImmediate,
    GreatPushInstallModeOnNextRestart,
    GreatPushInstallModeOnNextResume,
    GreatPushInstallModeOnNextSuspend
};

typedef NS_ENUM(NSInteger, GreatPushUpdateState) {
    GreatPushUpdateStateRunning,
    GreatPushUpdateStatePending,
    GreatPushUpdateStateLatest
};
