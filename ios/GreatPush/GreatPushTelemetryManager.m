...
static NSString *const LastDeploymentReportKey = @"GREAT_PUSH_LAST_DEPLOYMENT_REPORT";
...
static NSString *const RetryDeploymentReportKey = @"GREAT_PUSH_RETRY_DEPLOYMENT_REPORT";
static NSString *const StatusKey = @"status";

@implementation GreatPushTelemetryManager
...
+ (NSDictionary *)getBinaryUpdateReport:(NSString *)appVersion
{
    ...
    if (previousStatusReportIdentifier == nil) {
        ...
        if ([self isStatusReportIdentifierGreatPushLabel:previousStatusReportIdentifier]) {
...
+ (BOOL)isStatusReportIdentifierGreatPushLabel:(NSString *)statusReportIdentifier
{
