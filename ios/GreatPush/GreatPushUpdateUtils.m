...
@implementation GreatPushUpdateUtils

NSString * const AssetsFolderName = @"assets";
NSString * const BinaryHashKey = @"GreatPushBinaryHash";
NSString * const ManifestFolderPrefix = @"GreatPush";
NSString * const BundleJWTFile = @".greatpushrelease";
...
NSString * const IgnoreGreatPushMetadata = @".greatpushrelease";
...
+ (BOOL)isHashIgnoredFor:(NSString *) relativePath
{
    ...
    || [relativePath isEqualToString:IgnoreGreatPushMetadata]
    || [relativePath hasSuffix:[NSString stringWithFormat:@"/%@", IgnoreGreatPushMetadata]];
}
                                 ...
                                 error:(NSError **)error
{
    ...
    NSString *assetsPath = [GreatPush bundleAssetsPath];
                        ...
                        error:(NSError **)error
{
    ...
    if ([[NSFileManager defaultManager] fileExistsAtPath:signatureFilePath]) {
        ...
        *error = [GreatPushErrorUtils errorWithMessage:[NSString stringWithFormat: @"Cannot find signature at %@", signatureFilePath]];
        return nil;
    }
}
