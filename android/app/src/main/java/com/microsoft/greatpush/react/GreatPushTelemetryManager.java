...
public class GreatPushTelemetryManager {
    ...
    private final String LAST_DEPLOYMENT_REPORT_KEY = "GREAT_PUSH_LAST_DEPLOYMENT_REPORT";
    ...
    private final String RETRY_DEPLOYMENT_REPORT_KEY = "GREAT_PUSH_RETRY_DEPLOYMENT_REPORT";
    private final String STATUS_KEY = "status";

    public GreatPushTelemetryManager(Context applicationContext) {
    ...
    public WritableMap getBinaryUpdateReport(String appVersion) {
        ...
        if (previousStatusReportIdentifier == null) {
            ...
            this.clearRetryStatusReport();
            reportMap = Arguments.createMap();
            if (this.isStatusReportIdentifierGreatPushLabel(previousStatusReportIdentifier)) {
    ...
    public WritableMap getRetryStatusReport() {
        ...
        if (retryStatusReportString != null) {
            ...
            try {
                ...
                return GreatPushUtils.convertJsonObjectToWritable(retryStatusReport);
    ...
    public void saveStatusReportForRetry(ReadableMap statusReport) {
        JSONObject statusReportJSON = GreatPushUtils.convertReadableToJsonObject(statusReport);
    ...
    private String getPackageStatusReportIdentifier(ReadableMap updatePackage) {
        ...
        String deploymentKey = GreatPushUtils.tryGetString(updatePackage, DEPLOYMENT_KEY_KEY);
        String label = GreatPushUtils.tryGetString(updatePackage, LABEL_KEY);
    ...
    private boolean isStatusReportIdentifierGreatPushLabel(String statusReportIdentifier) {
