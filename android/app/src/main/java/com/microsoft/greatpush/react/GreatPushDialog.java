...
public class GreatPushDialog extends ReactContextBaseJavaModule{

    public GreatPushDialog(ReactApplicationContext reactContext) {
        super(reactContext);
    }
                ...
                try {
                    ...
                    switch (which) {
                        ...
                        case DialogInterface.BUTTON_NEGATIVE:
                            ...
                            break;
                        default:
                            throw new GreatPushUnknownException("Unknown button ID pressed.");
                    }
                } catch (Throwable e) {
