...
public class GreatPushUtils {
    ...
    public static WritableArray convertJsonArrayToWritable(JSONArray jsonArr) {
        ...
        for (int i=0; i<jsonArr.length(); i++) {
            ...
            try {
                ...
                // Should not happen.
                throw new GreatPushUnknownException(i + " should be within bounds of array " + jsonArr.toString(), jsonException);
            }
            ...
            if (obj instanceof JSONObject)
                ...
                throw new GreatPushUnknownException("Unrecognized object: " + obj);
        }
    ...
    public static WritableMap convertJsonObjectToWritable(JSONObject jsonObj) {
        ...
        while(it.hasNext()){
            ...
            try {
                ...
                // Should not happen.
                throw new GreatPushUnknownException("Key " + key + " should exist in " + jsonObj.toString() + ".", jsonException);
            }
                ...
                case Number:
                    ...
                    if ((number == Math.floor(number)) && !Double.isInfinite(number)) {
                        ...
                        try {
                            ...
                            throw new GreatPushUnknownException("Unable to put value " + arr.getDouble(i) + " in JSONArray");
                        }
                    }
                    break;
                case Boolean:
            ...
            try {
                switch (type) {
                    ...
                    case Null:
                        ...
                        break;
                    default:
                        throw new GreatPushUnknownException("Unrecognized type: " + type + " of key: " + key);
                }
            } catch (JSONException jsonException) {
                throw new GreatPushUnknownException("Error setting key: " + key + " in JSONObject", jsonException);
            }
        }
    ...
    public static JSONObject getJsonObjectFromFile(String filePath) throws IOException {
        ...
        try {
            ...
            // Should not happen
            throw new GreatPushMalformedDataException(filePath, jsonException);
        }
    }

    public static void log(String message) {
        Log.d(GreatPushConstants.REACT_NATIVE_LOG_TAG, "[GreatPush] " + message);
    }

    public static void log(Throwable tr) {
        Log.e(GreatPushConstants.REACT_NATIVE_LOG_TAG, "[GreatPush] Exception", tr);
    }
    ...
    public static void setJSONValueForKey(JSONObject json, String key, Object value) {
        try {
            ...
            throw new GreatPushUnknownException("Unable to set value " + value + " for key " + key + " to JSONObject");
        }
    }
