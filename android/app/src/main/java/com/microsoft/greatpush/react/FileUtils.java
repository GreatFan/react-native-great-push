...
public class FileUtils {
        ...
        for (File sourceFile : sourceDir.listFiles()) {
            if (sourceFile.isDirectory()) {
                copyDirectoryContents(
                        GreatPushUtils.appendPathComponent(sourceDirectoryPath, sourceFile.getName()),
                        GreatPushUtils.appendPathComponent(destinationDirectoryPath, sourceFile.getName()));
            } else {
    ...
    public static void deleteDirectoryAtPath(String directoryPath) {
        if (directoryPath == null) {
            GreatPushUtils.log("deleteDirectoryAtPath attempted with null directoryPath");
            return;
        }
    ...
    public static void deleteFileOrFolderSilently(File file) {
        ...
        if (!file.delete()) {
            GreatPushUtils.log("Error deleting file " + file.getName());
        }
    }
    ...
    public static void moveFile(File fileToMove, String newFolderPath, String newFileName) {
        ...
        if (!fileToMove.renameTo(newFilePath)) {
            throw new GreatPushUnknownException("Unable to move file from " +
