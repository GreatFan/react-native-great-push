...
var TestUtil = (function () {
    ...
    TestUtil.archiveFolder = function (sourceFolder, targetFolder, archivePath, isDiff) {
        ...
        if (isDiff) {
            archive.append("{\"deletedFiles\":[]}", { name: "hotgreatpush.json" });
        }
    ...
    TestUtil.ANDROID_KEY_PLACEHOLDER = "GREAT_PUSH_ANDROID_DEPLOYMENT_KEY";
    TestUtil.IOS_KEY_PLACEHOLDER = "GREAT_PUSH_IOS_DEPLOYMENT_KEY";
    TestUtil.SERVER_URL_PLACEHOLDER = "GREAT_PUSH_SERVER_URL";
    TestUtil.INDEX_JS_PLACEHOLDER = "GREAT_PUSH_INDEX_JS_PATH";
    TestUtil.GREAT_PUSH_APP_VERSION_PLACEHOLDER = "GREAT_PUSH_APP_VERSION";
    TestUtil.GREAT_PUSH_TEST_APP_NAME_PLACEHOLDER = "GREAT_PUSH_TEST_APP_NAME";
    TestUtil.GREAT_PUSH_APP_ID_PLACEHOLDER = "GREAT_PUSH_TEST_APPLICATION_ID";
    TestUtil.PLUGIN_VERSION_PLACEHOLDER = "GREAT_PUSH_PLUGIN_VERSION";
    return TestUtil;
}());
