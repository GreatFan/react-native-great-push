declare module 'great-push-plugin-testing-framework/script/platform' {
	import Q = require("q");
	/**
	 * Defines a platform supported by GreatPush.
	 */
...
declare module 'great-push-plugin-testing-framework/script/projectManager' {
	import Q = require("q");
	import platform = require('great-push-plugin-testing-framework/script/platform');
	/**
...
declare module 'great-push-plugin-testing-framework/script/test' {
	import Platform = require('great-push-plugin-testing-framework/script/platform');
	import { ProjectManager } from 'great-push-plugin-testing-framework/script/projectManager';
	/**
...
declare module 'great-push-plugin-testing-framework/script/serverUtil' {
	import platform = require('great-push-plugin-testing-framework/script/platform');
	import Q = require("q");
	...
	/**
	 * Class used to mock the greatPush.checkForUpdate() response from the server.
	 */
	...
	/**
	 * The model class of the greatPush.checkForUpdate() request to the server.
	 */
...
declare module 'great-push-plugin-testing-framework/script/testBuilder' {
	import Platform = require('great-push-plugin-testing-framework/script/platform');
	import { ProjectManager } from 'great-push-plugin-testing-framework/script/projectManager';
...
declare module 'great-push-plugin-testing-framework/script/testConfig' {
...
declare module 'great-push-plugin-testing-framework/script/testUtil' {
	import Q = require("q");
	export class TestUtil {
	    ...
	    static GREAT_PUSH_APP_VERSION_PLACEHOLDER: string;
	    static GREAT_PUSH_TEST_APP_NAME_PLACEHOLDER: string;
	    static GREAT_PUSH_APP_ID_PLACEHOLDER: string;
...
declare module 'great-push-plugin-testing-framework/script/index' {
	import * as Platform from 'great-push-plugin-testing-framework/script/platform';
	import * as PluginTestingFramework from 'great-push-plugin-testing-framework/script/test';
	import { ProjectManager, setupTestRunScenario, setupUpdateScenario } from 'great-push-plugin-testing-framework/script/projectManager';
	import * as ServerUtil from 'great-push-plugin-testing-framework/script/serverUtil';
	import { TestBuilder } from 'great-push-plugin-testing-framework/script/testBuilder';
	import * as TestConfig from 'great-push-plugin-testing-framework/script/testConfig';
	import { TestUtil } from 'great-push-plugin-testing-framework/script/testUtil';
...
declare module 'great-push-plugin-testing-framework' {
	import main = require('great-push-plugin-testing-framework/script/index');
	export = main;
}
