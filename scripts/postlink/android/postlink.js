...
module.exports = () => {
    ...
    https://github.com/microsoft/react-native-great-push#plugin-configuration-android for more details`);
        }
    }
    ...
    https://github.com/microsoft/react-native-great-push#plugin-installation-android---manual`);
    }

    // 2. Add the greatpush.gradle build task definitions
    var buildGradleContents = fs.readFileSync(buildGradlePath, "utf8");
    var reactGradleLink = buildGradleContents.match(/\napply from: ["'].*?react\.gradle["']/)[0];
    var greatPushGradleLink = `apply from: "../../node_modules/react-native-great-push/android/greatpush.gradle"`;
    if (~buildGradleContents.indexOf(greatPushGradleLink)) {
        console.log(`"greatpush.gradle" is already linked in the build definition`);
    } else {
