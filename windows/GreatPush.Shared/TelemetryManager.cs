...
[assembly: InternalsVisibleTo("GreatPush.Net46.Test")]

namespace GreatPush.ReactNative
{
    /// <summary>
    /// Implementation is ported from 
    /// android\app\src\main\java\com\microsoft\greatpush\react\GreatPushTelemetry.java
    ...
    internal class TelemetryManager
    {
        ...
        private static readonly string LAST_DEPLOYMENT_REPORT_KEY = "GREAT_PUSH_LAST_DEPLOYMENT_REPORT";
        ...
        private static readonly string RETRY_DEPLOYMENT_REPORT_KEY = "GREAT_PUSH_RETRY_DEPLOYMENT_REPORT";
        ...
        internal static JObject GetBinaryUpdateReport(string appVersion)
        {
            ...
            if (!previousStatusReportIdentifier.Equals(appVersion))
            {
                ...
                var report = new JObject();
                report.Add(APP_VERSION_KEY, appVersion);
                if (IsStatusReportIdentifierGreatPushLabel(previousStatusReportIdentifier))
                {
        ...
        static bool IsStatusReportIdentifierGreatPushLabel(string statusReportIdentifier)
        {
